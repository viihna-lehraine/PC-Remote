...
# File: scripts/vault/decrypt-root-token.sh

set -euo pipefail

WORK_DIR="/home/viihna/Projects/pc-remote"
SOPS_PGP_KEY_ID="B5BC332A603B022E21E46F2DA18BAE412BC0A77C"
ENCRYPTED_TOKEN="$WORK_DIR/secrets/tokens/.vault-root-token.sops"
DECRYPTED_TOKEN="$WORK_DIR/secrets/tokens/.vault-root-token"
